...
internal class LocatingDictionaryNodeDeserializer : INodeDeserializer
{
    private readonly INodeDeserializer _inner;
    private readonly ParsingContext _context;

    public LocatingDictionaryNodeDeserializer(INodeDeserializer inner, ParsingContext context)
    {
        _inner = inner;
        _context = context;
    }
